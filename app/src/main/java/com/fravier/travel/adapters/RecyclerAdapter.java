...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {
    ...
    private List<Driver> vouchers;
    public Context ctx;

    public RecyclerAdapter(List<Driver> vouchers) {
    ...
    public long getItemId(int position) {
        long id = vouchers.get(position).getId();
    ...
    public void onBindViewHolder(MyViewHolder viewHolder, int i) {
        Driver ci = vouchers.get(i);
        viewHolder.vName.setText(ci.getName());
        viewHolder.vDescription.setText(ci.getNational_id());
...
//            vComments = (TextView) v.findViewById(R.id.txComments);
