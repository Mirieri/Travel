 ...
 */
public class TownRecyclerAdapter extends RecyclerView.Adapter<TownRecyclerAdapter.MyViewHolder> {

    private List<Town> towns;
    public Context ctx;

    public TownRecyclerAdapter(List<Town> towns) {
        this.towns = towns;
    }
    ...
    public long getItemId(int position) {
        long id = towns.get(position).getId();
