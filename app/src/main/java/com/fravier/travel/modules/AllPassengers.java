 ...
 */
public class AllPassengers extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_all_passengers, container, false);
                                                    ...
                                                    .setAction("DELETE", new View.OnClickListener() {
                                                        ...
                                                        public void onClick(View view) {
                                                            if (cupboard().withDatabase(db).delete(lstItems.get(pos))) {
                                                                ...
                                                                Snackbar snackbar = Snackbar.make(coordinatorLayout, "A problem was encountered while attempting to delete the item.", Snackbar.LENGTH_SHORT);
                                                                View v = snackbar.getView();
                                                                TextView tv = (TextView) v.findViewById(android.support.design.R.id.snackbar_text);
                                                                tv.setTextColor(Color.WHITE);
                                                                snackbar.show();
        ...
        builder.onPositive(new MaterialDialog.SingleButtonCallback() {
            ...
            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                ...
                if (id > 0) {
                    ...
                    recyclerStuff("");
                    mAdapter.notifyDataSetChanged();
                    Snackbar snackbar = Snackbar.make(coordinatorLayout, "The passenger record was successfully saved", Snackbar.LENGTH_LONG);
                    View v = snackbar.getView();
                    TextView tv = (TextView) v.findViewById(android.support.design.R.id.snackbar_text);
                    tv.setTextColor(Color.WHITE);
                    snackbar.show();
                } else {
                    Snackbar snackbar = Snackbar.make(coordinatorLayout, "There were problems saving the passengers records\n" +
